<h1 align="center">
  <samp>
    Hey there <img src="https://raw.githubusercontent.com/MartinHeinz/MartinHeinz/master/wave.gif" width="30px">, I'm Jaspinder Singh!
  </samp>
</h1>

<p align="center">
  <samp>
    Python-loving Cyber-enthusiast | Data-Science Intern | Final-year CSE @ IKG PTU
  </samp>
</p>
...
|--------|-------------|------|
| **Plagiarism-Detector** | NLP-powered tool that checks submissions against 10 M+ online sources with paraphrase detection. | [:rocket: Live Demo](https://github.com/JASS1299/Plagiarism-Detector) |
| **Wine-Quality-ML** | Predict wine quality from chemical properties (Random-Forest, 92 % F1). | [:chart: Notebook](https://github.com/JASS1299/Wine-Quality-ML) |
| **House-Price-Predictor** | Regression model trained on 40 k+ Bengaluru listings. | [:house: Notebook](https://github.com/JASS1299/House-Price-Predictor) |
...
- 🔐 Cyber-security enthusiast (MasterCard job-simulation graduate).  
- 🛠 6-month internship @ Hoping Mind – delivered 100 % data-handling OKRs.  
- 🌱 Currently diving into FastAPI, Docker & CI/CD.  
- 📄 [Download my résumé](https://github.com/JASS1299/JASS1299/raw/main/resume.pdf)
