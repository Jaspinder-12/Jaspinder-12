...
I am targeting **fresher and entry-level opportunities**, especially remote roles, where I can turn hands-on labs and projects into real operational experience.
...
| Status | Area                                              |
| ------ | ------------------------------------------------- |
| ✅      | Python foundations for security automation        |
| ✅      | SQL fundamentals                                  |
...
Security-focused static analysis project that examines Python code for risky patterns and produces structured findings.

**Focus:**

* Static code analysis
* Security-oriented rule detection
...
* KQL-based investigation concepts
* Alert investigation
...
Practical web-security learning through labs and penetration-testing exercises.

**Focus:**

* Web application security
* Vulnerability identification
* Reconnaissance and testing concepts
...
* Automate repetitive work where it makes sense
* Document findings so someone else can reproduce them
* Think about security while building and debugging systems

---

## 📚 Security Learning & Virtual Experiences

* 🛡️ Mastercard Cybersecurity Virtual Experience
* 🏦 Commonwealth Bank Cybersecurity Virtual Experience
* 🔍 Microsoft Sentinel security learning
...
SOC Projects + Portfolio
        ↓
SOC Analyst L1 / IT Support / Security Operations
```
...
* Understand the system before touching the tool
* Prefer evidence over assumptions
* Keep scripts simple, readable, and reusable
* Reproduce problems before attempting fixes
* Document what happened, why it happened, and what changed
* Build projects that demonstrate investigation, not just screenshots
...
1. **AI Code Risk Analyzer** — security tooling and Python
2. **SOC / SIEM Lab Work** — Sentinel, Splunk, log analysis
3. **Web Security Labs** — vulnerability discovery and reporting
4. **Python Automation** — scripts that reduce repetitive analyst work
5. **MGR-S Complete** — engineering and automation practice
